                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <ul class="footer_payment text-center text-lg-right">
                            @if (theme_option('payment_method_1'))
                                <li><img src="{{ RvMedia::getImageUrl(theme_option('payment_method_1')) }}" alt="payment method"></li>
                            @endif
                            @if (theme_option('payment_method_2'))
                                <li><img src="{{ RvMedia::getImageUrl(theme_option('payment_method_2')) }}" alt="payment method"></li>
                            @endif
                            @if (theme_option('payment_method_3'))
                                <li><img src="{{ RvMedia::getImageUrl(theme_option('payment_method_3')) }}" alt="payment method"></li>
                            @endif
                            @if (theme_option('payment_method_4'))
                                <li><img src="{{ RvMedia::getImageUrl(theme_option('payment_method_4')) }}" alt="payment method"></li>
                            @endif
                            @if (theme_option('payment_method_5'))
                                <li><img src="{{ RvMedia::getImageUrl(theme_option('payment_method_5')) }}" alt="payment method"></li>
                            @endif
                            @if (theme_option('payment_method_6'))
                                <li><img src="{{ RvMedia::getImageUrl(theme_option('payment_method_6')) }}" alt="payment method"></li>
                            @endif
                        </ul>
                    </div>
                </div>
