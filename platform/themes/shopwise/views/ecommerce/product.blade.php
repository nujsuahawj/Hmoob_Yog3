        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7">
                ...
                <div class="product_description">
                    ...
                    @if (get_ecommerce_setting('review_enabled', '1') == '1')
                    ...
                    <div class="cart_extra">
                        <form class="add-to-cart-form" method="POST" action="{{ route('public.cart.add-to-cart') }}">
                            ...
                            <div class="cart_btn">
                                ...
                                <a class="add_wishlist js-add-favorite-button" href="{{ route('public.wishlist.add', $product->id) }}"><i class="icon-heart"></i></a>
                            </div>
                            <br>
                    ...
                    <div class="tab-content shop_info_tab">
                        ...
                        @if (get_ecommerce_setting('review_enabled', '1') == '1')
                            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
                                <div id="list-reviews">
                                    {!! Theme::partial('reviews', ['product' => $originalProduct, 'countRating' => $countRating]) !!}
                                </div>
