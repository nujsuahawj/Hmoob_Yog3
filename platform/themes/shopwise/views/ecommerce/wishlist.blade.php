                            ...
                            @foreach ($wishlist as $item)
                                <tr>
                                    ...
                                    <td style="width: 300px">
                                        <a class="btn btn-dark btn-sm js-remove-favorite-button" href="{{ route('public.wishlist.remove', $item->product_id) }}">{{ __('Remove') }}</a>
                            ...
                            @foreach(Cart::instance('wishlist')->content() as $cartItem)
                                ...
                                @if (!empty($item))
                                    <tr>
                                        ...
                                        <td style="width: 300px">
                                            <a class="btn btn-dark btn-sm js-remove-favorite-button" href="{{ route('public.wishlist.remove', $item->id) }}">{{ __('Remove') }}</a>
