    ...
    */
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function (Theme $theme)
        {
            ...
            $theme->asset()->container('footer')->usePath()->add('scripts', 'js/scripts.js', ['jquery'], [], '1.0.7');
            ...
            if (function_exists('shortcode')) {
                $theme->composer(['index', 'page', 'post', 'ecommerce.product'], function (\Botble\Shortcode\View\View $view) {
                    \Theme::asset()->container('footer')->usePath()->add('app-js', 'js/app.js', ['jquery', 'carousel-js'], [], '1.0.7');
                    $view->withShortcodes();
                });
            }
        },
