...
Route::group(['namespace' => 'Theme\Shopwise\Http\Controllers', 'middleware' => 'web'], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {

        Route::get('ajax/product-collections/{productCollectionId}/products', 'ShopwiseController@ajaxGetProducts')
