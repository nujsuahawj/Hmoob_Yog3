                ...
                <div class="form-checkout">
                    <form action="{{ route('payments.checkout') }}" method="post">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="amount" value="{{ Cart::instance('cart')->rawTotal() - $promotionDiscountAmount - $couponDiscountAmount }}">
                            ...
                            <ul class="list-group list_payment_method">
                                ...
                                {!! apply_filters(PAYMENT_FILTER_ADDITIONAL_PAYMENT_METHODS, null, ['amount' => Cart::instance('cart')->rawTotal() - $promotionDiscountAmount - $couponDiscountAmount, 'currency' => strtoupper(get_application_currency()->title), 'name' => null]) !!}
