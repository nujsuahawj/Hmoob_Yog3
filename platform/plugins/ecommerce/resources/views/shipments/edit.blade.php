                            ...
                            <div class="dropdown dropdown-menu dropdown-ps-left applist-style animate-scale-dropdown min-width-200-px" role="menu" aria-labelledby="dropdownfilter">
                                <div>
                                    <ul class="applist-menu">
                                        ...
                                        <li><a data-value="{{ \Botble\Ecommerce\Enums\ShippingCrossCheckingStatusEnum::COMPLETED }}" data-target="{{ route('ecommerce.shipments.update-cross-checking-status', $shipment->id) }}">{{ \Botble\Ecommerce\Enums\ShippingCrossCheckingStatusEnum::COMPLETED()->label() }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="wrapper-content">
                    ...
                    <div class="pd-all-20 p-t15 p-b15 border-top-title-main ps-relative">
                        ...
                        <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
                            ...
                            <div class="flexbox-grid-form-item text-right">
                                <a class="text-no-bold overflow-ellipsis block-display" target="_blank" title="{{ $shipment->shipment_id }}" href="{{ OrderHelper::getShippingDetailUrl($shipment->order->shipping_method) }}">{{ $shipment->shipment_id }}</a>
                            </div>
                        </div>
                        <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
                            <div class="flexbox-grid-form-item">
                                {{ __('Cash on delivery status (COD)') }}
                            </div>
                            <div class="flexbox-grid-form-item text-right">
                        ...
                        <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
                            <div class="flexbox-grid-form-item">
                                {{ __('Cross checking status') }}
                            </div>
                            <div class="flexbox-grid-form-item text-right">
                                <label class="label crosscheckstatus_1">{{ $shipment->cross_checking_status->label() }}</label>
                            </div>
                        </div>
                    </div>
                </div>
