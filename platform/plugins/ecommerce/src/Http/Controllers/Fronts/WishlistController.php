...
class WishlistController extends Controller
{
     ...
     */
    public function store($productId, Request $request, BaseHttpResponse $response)
    {
        ...
        if (!auth('customer')->check()) {
            ...
            return $response
                ->setMessage(__('Add product :product successfully!', ['product' => $product->name]))
    ...
    public function destroy($productId, BaseHttpResponse $response)
    {
        if (!auth('customer')->check()) {
            ...
            return $response
                ->setMessage(__('Remove item from Wishlist successfully!'))
                ->setData(['count' => Cart::instance('wishlist')->count()]);
        }
